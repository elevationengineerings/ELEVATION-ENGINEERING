      ...
      <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-orange-100 flex flex-col">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/offering/flameproof-materials" element={<FlameproofSupply />} />
            <Route path="/offering/precision-installation" element={<PrecisionInstallation />} />
            <Route path="/offering/testing-commissioning" element={<TestingCommissioning />} />
            <Route path="/offering/modernization-maintenance" element={<ModernizationMaintenance />} />
            <Route path="/innovation" element={<Innovation />} />
            <Route path="/sustainability" element={<Sustainability />} />
            <Route path="/safety" element={<Safety />} />
            <Route path="/suppliers" element={<Suppliers />} />
            <Route path="/gallery" element={<Gallery />} />
            <Route path="/insights/safety-standards" element={<InsightSafety />} />
            <Route path="/insights/energy-efficiency" element={<InsightEfficiency />} />
            <Route path="/insights/smart-infrastructure" element={<InsightInfrastructure />} />
